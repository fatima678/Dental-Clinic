...
// //                     {activeStep === 1 && (
// //                         <div className='p-8'>
// //                             <h2 className='text-2xl font-bold text-gray-800 mb-6 flex flex-items-center'>
// //                                 <FaUser className='mr-3 text-sky-500' />
// //                                 Personal Information
// //                             </h2>
// //                             <div className='space-y-6'>
// //                                 <div className='relative'>
// //                                     <input type="text" name="name" value={formData} onChange={handleInputChange}
...
//                                         type="text"
//                                         name="name"
//                                         // CORRECTED: changed value={formData} to value={formData.name}
//                                         value={formData.name}
//                                         onChange={handleInputChange}
//                                         placeholder='Full Name'
//                                         className='w-full p-4 pl-12 border-2 border-gray-200 rounded-xl focus:ring-2 
