...
// // // // // //       viewport={{ once: true }}
// // // // // //     >
// // // // // //       {/* your full form JSX remains the same */}
// // // // // //       {/* only handleSubmit and useEffect were changed */}
// // // // // //     </motion.section>
// // // // // //   );
// // // // // // };
...
// // // // //           </h1>
// // // // //           <p className="text-lg text-gray-600">
// // // // //             Fill out the details to book your dental appointment
// // // // //           </p>
// // // // //         </motion.div>
...
// // // //                 }}
// // // //                 disabled={!isLoggedIn}
// // // //                 className={`ml-auto px-6 py-3 font-medium rounded-lg flex items-center transition ${
// // // //                   isLoggedIn
...
// // //   // ✅ Check login status once when page loads
// // //   useEffect(() => {
// // //     const token = localStorage.getItem("token");
// // //     setIsLoggedIn(!!token);
// // //   }, []);
...
// // //       });
// // //       setActiveStep(1);
// // //       navigate("/profile"); // Redirect after booking
// // //     } catch (error) {
// // //       console.error(error);
// // //       alert(error.response?.data?.message || "Failed to book appointment");
// // //     }
...
// // //         {!isLoggedIn && (
// // //           <div className="mb-6 text-center bg-yellow-100 border border-yellow-300 text-yellow-800 font-medium py-3 rounded-xl">
// // //             🔒 Please login before booking your appointment.
// // //           </div>
// // //         )}
...
// //                 whileTap={{ scale: 0.95 }}
// //                 onClick={nextStep}
// //                 className="ml-auto px-6 py-3 font-medium rounded-lg flex items-center transition bg-sky-500 text-white hover:bg-sky-600"
// //               >
// //                 Next <FaChevronRight className="ml-2" />
// //               </motion.button>
// //             )}
...
//   const handleSubmit = () => {
//     setConfirmed(true); // ✅ Just mark confirmed
//   };
...
//   if (confirmed) {
//     return (
//       <section className="min-h-screen flex items-center justify-center bg-sky-50 p-4">
//         <motion.div
//           initial={{ opacity: 0, scale: 0.8 }}
//           animate={{ opacity: 1, scale: 1 }}
//           className="bg-white p-10 rounded-3xl shadow-lg text-center"
//         >
//           <GiToothbrush className="text-5xl text-sky-500 mx-auto mb-4" />
//           <h2 className="text-2xl font-bold text-gray-800 mb-2">
//             Appointment Confirmed!
//           </h2>
//           <p className="text-gray-600">
//             Thank you, {formData.name}. Your appointment is confirmed.
//           </p>
//         </motion.div>
//       </section>
//     );
...
//                 className="p-8 text-center"
//               >
//                 <GiToothbrush className="text-4xl text-sky-500 mb-4" />
//                 <h2 className="text-2xl font-bold text-gray-800 mb-4">
//                   Confirm Your Appointment
//                 </h2>
...
//                 <button
//                   onClick={handleSubmit}
//                   className="w-full py-4 bg-gradient-to-r from-sky-500 to-sky-500 text-white font-bold rounded-xl"
//                 >
//                   Confirm & Book Appointment
//                 </button>
//               </motion.div>
...
const BookAppointment = () => {
  ...
  if (confirmed) {
    return (
      <section className="scroll-mt-20 min-h-screen bg-gradient-to-br from-sky-50 to-sky-50 py-12 px-4 flex items-center justify-center">
        <motion.div
          initial={{ opacity: 0, scale: 0.8 }}
          animate={{ opacity: 1, scale: 1 }}
